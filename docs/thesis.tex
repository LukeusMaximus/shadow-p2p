...
%TODO is the binomial distribution valid; difference between binomial and this distribution, statistically significant
%TODO the distribution that the adversary actually gets due to thresholds
%TODO simulation of gathering many S and distinguishing members of V from them
