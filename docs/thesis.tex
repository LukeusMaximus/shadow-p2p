...
Contracting the network is basically a reverse of the expansion process in that the network width is halved in each dimension. In order to contract the network, the network has to represent  As nodes leave the network, they return their virtual positions to other nodes. 

%TODO is contraction actually necessary?
